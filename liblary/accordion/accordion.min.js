      ...
      , n = function e(n, s) {
        ...
        var r = {
            ...
            handleClick: function(e) {
                ...
                this.elements.forEach((function(s, i) {
                    s.contains(n) && "A" !== e.target.nodeName && (t.currFocusedIdx = i,
                    t.closeElements(),
                    t.focus(e, s),
                    t.toggleElement(s))
                }
        ...
        this.attachEvents = function() {
            if (!a) {
                ...
                r.elements.forEach((function(e) {
                    ...
                    i.addEventListener("webkitTransitionEnd", r.handleTransitionEnd),
        ...
        this.detachEvents = function() {
            if (a) {
                ...
                r.elements.forEach((function(e) {
                    ...
                    i.removeEventListener("webkitTransitionEnd", r.handleTransitionEnd),
        ...
        this.openAll = function() {
            var e = r.options
              ...
              , n = e.onOpen;
            r.elements.forEach((function(e) {
                e.classList.contains(t) || (r.showElement(e, !1),
                n(e))
            }
            ))
        }
        ...
        this.closeAll = function() {
            var e = r.options
              ...
              , n = e.onClose;
            r.elements.forEach((function(e) {
                e.classList.contains(t) && (r.closeElement(e, !1),
                n(e))
            }
            ))
        }
        ...
        ;
        var c = function(e) {
            return "string" == typeof document.documentElement.style[e] ? e : (e = l(e),
            e = "webkit".concat(e))
        }
          , l = function(e) {
